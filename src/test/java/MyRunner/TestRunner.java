...
@CucumberOptions(
		features = "F:\\Java\\BDDCucumber\\src\\main\\java\\Features\\login.feature",
		glue={"TestStep"},
		...
		//tags = {"@SmokeTest, @RegressionTest"}	//  "," == OR  , "~@RegressionTest", "~@End2End"
	...
	//skip: add a "~" before "@" : tags ={"~@RegressionTest"}
